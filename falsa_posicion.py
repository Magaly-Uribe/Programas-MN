...
class FalsaPosicionWindow(HoverButtonsMixin):
    def __init__(self, parent):
        self.parent = parent
        self.parent.title("Método de Falsa Posición")
    ...
    def create_widgets(self):
        ...
        title_label = tk.Label(
            title_frame,
            text="MÉTODO DE FALSA POSICIÓN (REGULA FALSI)",
            font=("Arial", 18, "bold"),
            fg="#2c3e50",
            bg=self.bg_color
        )
        ...
        columns = ('iter', 'a', 'c', 'b', 'f(a)', 'f(c)', 'f(b)', 'error')
        ...
        self.tree.column('a', width=100, anchor=tk.CENTER)
        self.tree.column('c', width=100, anchor=tk.CENTER)
        self.tree.column('b', width=100, anchor=tk.CENTER)
        self.tree.column('f(a)', width=120, anchor=tk.CENTER)
        self.tree.column('f(c)', width=120, anchor=tk.CENTER)
        self.tree.column('f(b)', width=120, anchor=tk.CENTER)
    ...
    def render_procedimiento_falsa_posicion(self, resultados):
        lines = []
    ...
    def calcular(self):
        ...
        try:
            ...
            # Ejecutar método
            raiz, resultados = self.solver.falsa_posicion()
            ...
            texto = self.render_procedimiento_falsa_posicion(resultados)
