...
class PuntoFijoWindow:
    def __init__(self, parent):
        self.parent = parent
        self.parent.title("Método de Punto Fijo")
    ...
    def create_widgets(self):
        ...
        self.func_entry.insert(0, "(x**2 + 5)/6")
        ...
        self.a_entry.grid(row=0, column=3, padx=(0, 20), pady=5, sticky=tk.W)
        ...
        self.b_entry.grid(row=0, column=5, padx=(0, 20), pady=5, sticky=tk.W)
        ...
        tk.Label(
            ...
            font=("Arial", 11),
            bg=self.bg_color
        ).grid(row=1, column=0, padx=(0, 5), pady=5, sticky=tk.W)
        ...
        self.error_entry.grid(row=1, column=1, padx=(0, 20), pady=5, sticky=tk.W)
        ...
        tk.Label(
            ...
            font=("Arial", 11),
            bg=self.bg_color
        ).grid(row=1, column=2, padx=(0, 5), pady=5, sticky=tk.W)
        ...
        self.iter_entry.grid(row=1, column=3, padx=(0, 0), pady=5, sticky=tk.W)
        ...
        self.tree.column('g(x)', width=120, anchor=tk.CENTER)
    ...
    def calcular(self):
        ...
        try:
            ...
            if x0 < a or x0 > b:
                messagebox.showerror("Error", "x₀ debe estar dentro del intervalo [a, b]")
                return
            ...
            # Ejecutar método
            raiz, resultados = self.solver.punto_fijo(x0, a, b)
            ...
            messagebox.showinfo(
                "Éxito",
                f"Punto fijo encontrado: {raiz:.10f}\n"
